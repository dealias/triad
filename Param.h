...
extern size_t NParam;
extern bool param_warn;
...
class ParamBase {
 ...
 public:
  ...
  virtual void GraphicsOutput(ostream& os, bool define=false)=0;
...
class VocabularyBase {
 ...
 public:
  ...
  void Parse(char *s);
  void Assign(const char *s, bool warn=true);
  void Sort();
  void List(ostream& os);
  void Dump(ostream& os);
  void GraphicsDump(ostream& os, bool define);
  virtual const char *Name()=0;
...
#define VOCAB_ARRAY(var,help) \
  Vocab(var,#var,*var,*var,true,help,(size_t) (sizeof(var)/sizeof(*var)), 1)
...
class Param : public ParamBase {
 ...
 public:
  ...
  void GraphicsOutput(ostream& os, bool define=false);
...
inline void Vocab(T *var, const char *s, T min, T max, bool unlimited,
		  const char *help, size_t n, size_t dump)
{
  (void) new Param<T>(var,s,n,min,max,unlimited,help,dump);
}

template<class T>
inline void Vocab(T *var, const char *s, const char *help, size_t n, size_t dump)
{
  (void) new Param<T>(var,s,n,T(),T(),true,help,dump);
}

inline void Vocab(size_t *var, const char *s, size_t min, size_t max,
		  bool unlimited, const char *help, size_t n, size_t dump)
{
  (void) new Param<size_t>(var,s,n,(size_t) min,(size_t) max,
				 unlimited,help,dump);
}
...
inline size_t atosize(const char *s)
{
  return (size_t) atoll(s);
}
...
template<>
inline void Param<size_t>::SetStr(const char *s) {get_values(s,&atosize);}
template<>
...
template<>
inline int Param<size_t>::InRange(size_t value)
{
  return unlimited || (value >= min && value <= max);
}
template<>
...
template<>
inline void Param<size_t>::GraphicsOutput(ostream& os, bool define) {
  Out(os,"int",define);
}

template<>
inline void Param<int>::GraphicsOutput(ostream& os, bool define) {
  Out(os,"int",define);
}

template<>
inline void Param<long>::GraphicsOutput(ostream& os, bool define) {
  Out(os,"int",define);
}

template<>
inline void Param<long long>::GraphicsOutput(ostream& os, bool define) {
  Out(os,"int",define);
}

template<>
inline void Param<double>::GraphicsOutput(ostream& os, bool define) {
  Out(os,"real",define);
}

template<>
inline void Param<Complex>::GraphicsOutput(ostream& os, bool define) {
  Out(os,"pair",define);
}

template<>
inline void Param<const char *>::GraphicsOutput(ostream& os, bool define) {
