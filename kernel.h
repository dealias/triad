...
typedef array1<Var>::opt __restrict vector;
typedef array1<Real>::opt __restrict rvector;
typedef array1<int>::opt __restrict ivector;
typedef array1<unsigned int>::opt __restrict uvector;
